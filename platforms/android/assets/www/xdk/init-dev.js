...
dev.BROWSER = 600 ;						//Calato il tempo in modo da velocizzare il caricamento dell'app
...
// *********************************************************************************	
// Di seguito le funzione eseguibili quando vengono gestiti l'exit dall'applicazione o eventi simili
// Eventi ancora da testare, controllare la console per capire quando questi vengono lanciati
// mentre viene esguita l'app in debug sul cellulare fisico
...
myLoadListener= function() {
	console.log("Load Event: puoi recuperare i dati")
} ;	

myUnloadListener= function() {
	console.log("Unload Event: puoi salvare i dati")
} ;	
...
// *********************************************************************************	
// Aggiunti gli i listeners sui diversi eventi dell'applicazione:
	document.addEventListener("deviceready", myDeviceReadyListener, false);	
	document.addEventListener("resume", myResumeListener, false);	
	document.addEventListener("pause", myPauseListener, false);
	document.addEventListener("window.onload", myLoadListener, false);
	document.addEventListener("window.onunload", myUnloadListener, false);

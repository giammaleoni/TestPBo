...
parkAttuale = function(){
	...
	if (parcheggio == null || parcheggio == "" || typeof parcheggio == 'undefined'){
		...
		if (matrixLavaggio.getObjectById(parcheggio).dettaglioHera){
			document.getElementById("park_id").innerHTML = "<i>Parcheggiato in </i><br>" + matrixLavaggio.getObjectById(parcheggio).viaGoogle +", <i>" + matrixLavaggio.getObjectById(parcheggio).dettaglioHera + "</i>";
		}else{
			document.getElementById("park_id").innerHTML = "<i>Parcheggiato in </i><br>" + matrixLavaggio.getObjectById(parcheggio).viaGoogle;
		}
